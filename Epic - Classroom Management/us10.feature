Feature: Alertas de Indicadores de Rendimiento Bajo
...
Escenario: Identificación de estudiantes con rendimiento bajo por grado
...
Escenario: Generación y envío de alertas de rendimiento
